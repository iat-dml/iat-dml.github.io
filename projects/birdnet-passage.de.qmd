...
::: {.callout-note}
**Bald verfügbar.** Der Code von BirdNET-Passage wird derzeit für die erste versionierte Veröffentlichung vorbereitet, die wir in Kürze erwarten. Bis dahin ist der Code noch nicht öffentlich zugänglich. Wenn Sie Interesse an der Nutzung haben, [melden Sie sich gern bei uns](mailto:iat-dml@zalf.de). Wir geben Ihnen Bescheid, sobald er verfügbar ist.
:::

BirdNET-Passage ist eine Forschungssoftware, die [BirdNET-Analyzer](https://github.com/birdnet-team/BirdNET-Analyzer) auf sehr große Sammlungen von Audioaufnahmen anwendet. BirdNET ist ein KI-Modell, das Vogelarten anhand ihrer Rufe und Gesänge erkennt. BirdNET-Passage verändert das Modell nicht. Stattdessen sorgt die Software dafür, dass Tausende Dateien schnell durch das Modell laufen und dass für jede Datei nachvollziehbar ist, was mit ihr geschehen ist. Wir entwickeln sie gemeinsam mit Marie Perennes und ihrer Gruppe.
